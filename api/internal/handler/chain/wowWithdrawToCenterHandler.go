...
func WowWithdrawToCenterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := chain.NewWowWithdrawToCenterLogic(r.Context(), svcCtx)
		resp, err := l.WowWithdrawToCenter(&req)
		if err != nil {
			response.MakeError(r.Context(), w, err, response.ParamParseErrorCode)
		} else {
